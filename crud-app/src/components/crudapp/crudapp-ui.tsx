...
function CrudappCard({ account }: { account: PublicKey }) {
  ...
  return accountQuery.isLoading ? (
    ...
    <div className="card card-bordered border-base-300 border-4 text-neautral-content">
      <div className="card-body items-center text-center">
        ...
        <div className="card-action justify-around">
          <textarea 
          placeholder='Message'
          value={message}
          onChange={(e) => setMessage(e.target.value)}
          className="textarea textarea-brodered w-full max-w-xs"
          />
          <button
          onClick={handleSubmit}
          disabled={updateEntry.isPending || !isFormValid}
          className="btn btn-cs lg:btn-md btn-primary">
